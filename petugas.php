              ...
              <tbody class="text-center">
                ...
                ?>
                  <tr id="table-data">
                    ...
                    <td>
                      <a href="edit_petugas.php?id=<?php echo $result['user_id']; ?>" class="bi bi-pencil-square"></a>
                      <a href="hapus_petugas.php?id=<?php echo $result['user_id']; ?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['nama']; ?>?')" class="bi bi-x-octagon"></a>
                    </td>
                  </tr>
                <?php } ?>
        ...
        <div class="modal-body">
          <form method="post" action="proses_tambah_petugas.php">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="password" class="form-control" id="alamat" required>
            </div>
