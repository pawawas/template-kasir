                            ...
                            <tbody class="text-center">
                                ...
                                ?>
                                    <tr id="table-data">
                                        ...
                                        <td>
                                            <a href="edit_produk.php?id=<?php echo $result['produk_id']; ?>" class="bi bi-pencil-square"></a>
                                            <a href="hapus_produk.php?id=<?php echo $result['produk_id']; ?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['nama_produk']; ?>?')" class="bi bi-x-octagon"></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                ...
                <div class="modal-body">
                    <form action="proses_tambah_produk.php" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" id="produk">
                        </div>
                        <div class="mb-3">
