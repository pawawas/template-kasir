                    ...
                    <div class="card-body">
                        <form method="post" action="proses_edit_pelanggan.php">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['nama_pelanggan']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Alamat</label>
                                <input type="text" name="alamat" class="form-control" id="alamat" value="<?php echo $result['alamat']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nomor Telepon</label>
                                <input type="text" name="nomer" class="form-control" id="nomer" value="<?php echo $result['nomor_telepon']; ?>" required>
                            </div>
