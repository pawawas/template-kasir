                    ...
                    <div class="card-body">
                        <form method="post" action="proses_edit_petugas.php">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control" id="barang" value="<?php echo $result['nama']; ?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Password</label>
                                <input type="checkbox" name="ubah" value="true"> Ceklis jika ingin mengubah password<br>
                                <input type="text" name="password" class="form-control" id="alamat" placeholder="Silahkan masukkan password baru" >
                            </div>
                    </div>
